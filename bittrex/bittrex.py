...
class Bittrex(object):
    ...
    def buy_limit(self, market, quantity, rate, timeInForce='GTC'):
        """
        ...
        return self._api_query(path_dict={
            API_V1_1: '/market/buylimit',
                    ...
                    'quantity': quantity,
                    'rate': rate,
                    'timeInForce': timeInForce}, protection=PROTECTION_PRV)

    def sell_limit(self, market, quantity, rate, timeInForce='GTC'):
        """
